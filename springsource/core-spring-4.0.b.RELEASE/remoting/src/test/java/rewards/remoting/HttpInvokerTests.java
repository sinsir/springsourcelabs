 ...
 */
// TODO-08: Provide the proper config file location
...
public class HttpInvokerTests {
	...
	public void testHttpInvokerClient() {
		...
		//	TODO-09: Call the 'rewardAccountFor(..)' method.  
		//	Note that your call will actually be executed on the server via RMI.
		//	Run this test, it should pass.
		//	Compare this test class to the RmiTest, it is nearly identical.  Do you understand why?
