...
public class Beneficiary {
	...
	//         	For each, use @AttributeOverride to map column name to the underlying property.
	//			Syntax:  @AttributeOverride (name="PROPERTY", column=@Column(name="COLUMN"))
	//			For allocationPercentage, the 'value' property will be mapped to the "ALLOCATION_PERCENTAGE" column.
	//			For MonetaryAmount, the 'value' property will be mapped to the "SAVINGS" column.
