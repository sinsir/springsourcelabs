...
public class RewardNetworkTests  {
	...
	public void setUp() {
		...
		// TODO-04: Replace the following instruction with one that instantiates Spring from 
		//	XML files.  Use ClassPathXmlApplicationContext.  Specify "rewards-config.xml" and
		//  "test-infrastructure-config.xml" as configuration files -- you will need to specify
		//  the classpath locations of the files.  Save your work and re-run this test, it should pass.
		context = 
